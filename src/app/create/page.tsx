...
function CreateSwitchPageInner() {
  ...
  }, [canSubmit, addSwitch, switchTitle, beneficiaryName, beneficiaryAddress, effectiveBeneficiary, parsedAmount, days, demoMode, telegramMode, telegramHandle, beneficiaryEmail]);
